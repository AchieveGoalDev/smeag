...
<div class="w-2/3 mx-auto grid grid-cols-2 grid-rows-1 place-content-center min-h-[500px]">
	<div class="col-start-1 col-span-1 h-full relative">
		<canvas id="chart" />
	</div>
	<div
		class="col-span-1 flex flex-col items-center justify-center w-full h-full relative font-heading-jp"
	>
		<div class="square" />
